...
export function buildFont(
  ...
  if (usableGlyphs.length === 0) {
    throw new Error("Generate at least one valid uppercase glyph before exporting.");
  }
  ...
  const font = new opentype.Font({
    ...
    description:
      options.description ??
      "Generated by Typegen MVP from uppercase Figma vector glyphs.",
    glyphs,
  });
...
function collectBuildWarnings(
  ...
  if (usableGlyphs.length < 26) {
    warnings.add(`Font generated with ${usableGlyphs.length}/26 uppercase glyphs.`);
  }
